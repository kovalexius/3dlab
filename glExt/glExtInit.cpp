...
bool Init_VertexArray( void )
{
    ...
    rez = glVertexAttribPointer && glEnableVertexAttribArray && 
        glBindAttribLocation && glGetAttribLocation && 
        glGetActiveAttrib && glGetUniformLocation;
...
bool Init_ShaderObjects( void )
{
    ...
    rez = glCreateShader && glShaderSource && 
        glCompileShader && glCreateProgram && 
        glAttachShader && glLinkProgram && 
        glUseProgram && glGetShaderiv && 
        glGetShaderInfoLog && glGetProgramiv &&
        glDeleteProgram && glGetProgramInfoLog;
